...
resource "scalr_provider_configuration" "nested_resource" {
  ...
  custom {
    ...
    argument {
      name  = "username"
      value = "my-username"
      description = "probably-centrally-vertically-likely-currently-inherently-repeatedly-strongly-deeply-safely-willingly-clearly-intensely-repeatedly-frankly-lively-duly-blatantly-certainly-weekly-accurately-externally-openly-seriously-miserably-nationally-reliably-slightly-trivially-roughly-socially-equally-openly-severely-mutually-rapidly-infinitely-violently-thoroughly-sincerely-largely-roughly-largely-quickly-amazingly-likely-utterly-namely-only-openly-reliably-initially-surely-firmly-early-rarely-frequently-hopefully-newly-nicely-precisely-weekly-secretly-definitely-repeatedly-singularly-implicitly-adversely-likely-repeatedly-weekly-amazingly-uniformly-rapidly-honestly-adequately-immensely-indirectly-indirectly-commonly-loosely-regularly-clearly-scarcely-factually-admittedly-generally-privately-seemingly-vastly-overly-terribly-nominally-immensely-simply-usually-nationally-personally-blindly-genuinely-vastly-slightly-immensely-violently-privately-openly-hideously-kindly-poorly-rationally-yearly-loudly-illegally-lately-typically-apparently-enormously-repeatedly-yearly-certainly-slowly-evidently-secondly-vertically-randomly-blatantly-current-tapir"
    }
    argument {
      name      = "password"
